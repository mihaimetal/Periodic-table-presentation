...
k("- left gaps for future elements;"),k("- could predict the properties of the undiscovered elements;"))});this.onposition(134E3,function(){if(c)for(var a=0;a<15;a++){var b=h(1,100);$("#a"+b).fadeOut(3E3).delay(3E3).fadeIn(3E3)}});this.onposition(165E3,function(){c&&$("#a31").fadeOut(3E3).delay(3E3).fadeIn(3E3)});this.onposition(254E3,function(){c&&$("#a117").fadeOut(3E3).delay(3E3).fadeIn(3E3)});this.play({whileplaying:function(){l(this)}});$(window).blur(function(){j.paused||(g=!0,$("#tube-plug").animate({top:$("#tube-plug").position().top===
-100?-20:-100}),j.pause())});$(window).focus(function(){j.paused&&g&&(g=!1,$("#tube-plug").animate({top:$("#tube-plug").position().top===-100?-20:-100}),j.resume())});b.resolve()},onfinish:function(){this.play({whileplaying:function(){l(this)}});l(this,!0)}})})},l=function(b,a){if(b.position%5E3>4900||a){var d=b.position*100/b.duration/100*200;$("#tube1").find(".tube-liquid").animate({height:Math.round(d)+30})}},k=function(b,a){a=a||{};$("#blackboard").position().top!==8&&$("#blackboard").animate({top:8},
1E3);for(var d=$("#blackboard"),i=$("<p style='margin: "+(a.top?10:0)+"px 0 0 "+(a.left?50:0)+"px;'></p>").appendTo(d),c=1;c<=b.length;c++)(function(a,c){var i=b.substr(0,a-1)+"<span style='display:none;'>"+b.substr(a-1,1)+"</span>";d.queue(function(){c.html(i);d.dequeue()});d.queue(function(){c.find("span").fadeIn(180,function(){d.dequeue()})})})(c,i)},p=function(){for(var b=0;b<8;b++){var a=$("<div class='bubble' id='bubble"+b+"'></div>");a.appendTo("#tube1");(function(a){setTimeout(function(){m(a)},
h(100,3E3))})(a)}},m=function(b){var a=h(15,45),d=h(5,10),c=h(5,15);b.css({left:a,bottom:d,width:c,height:c});b.css({background:"#ffe4e1","border-radius":Math.round(c/2),opacity:"0.8"});b.css({background:"-webkit-gradient(radial, 20% 20%, 1, center center, "+Math.round(c/2)+", from(rgba(255,255,255,0.9)), color-stop(70%, rgba(255,255,255,0)), color-stop(99%, rgba(255,255,255,0.8)), to(rgba(255,255,255,0)))"});b.css({background:"-moz-radial-gradient(top left, rgba(255,255,255,0.8), rgba(255,255,255,0))"});

...
k("- left gaps for future elements;"),k("- could predict the properties of the undiscovered elements;"))});c.onposition(134E3,function(){if(h)for(var a=0;a<15;a++){var b=d(1,100);$("#a"+b).fadeOut(3E3).delay(3E3).fadeIn(3E3)}});c.onposition(165E3,function(){h&&$("#a31").fadeOut(3E3).delay(3E3).fadeIn(3E3)});c.onposition(254E3,function(){h&&$("#a117").fadeOut(3E3).delay(3E3).fadeIn(3E3)});$(window).blur(function(){c.paused||(i=!0,$("#tube-plug").animate({top:-20}),c.pause())});$(window).focus(function(){c.paused&&
i&&(i=!1,$("#tube-plug").animate({top:-100}),c.resume())});c.play({whileplaying:function(){l(c)}});b.resolve()},onfinish:function(){c.play({whileplaying:function(){l(c)}});l(c,!0)}})})},l=function(b,a){if(b.position%5E3>4900||a){var e=b.position*100/b.duration/100*200;$("#tube1").find(".tube-liquid").animate({height:Math.round(e)+30})}},k=function(b,a){a=a||{};$("#blackboard").position().top!==8&&$("#blackboard").animate({top:8},1E3);for(var e=$("#blackboard"),c=$("<p style='margin: "+(a.top?10:0)+
"px 0 0 "+(a.left?50:0)+"px;'></p>").appendTo(e),d=1;d<=b.length;d++)(function(a,c){var d=b.substr(0,a-1)+"<span style='display:none;'>"+b.substr(a-1,1)+"</span>";e.queue(function(){c.html(d);e.dequeue()});e.queue(function(){c.find("span").fadeIn(180,function(){e.dequeue()})})})(d,c)},p=function(){for(var b=0;b<8;b++){var a=$("<div class='bubble' id='bubble"+b+"'></div>");a.appendTo("#tube1");(function(a){setTimeout(function(){m(a)},d(100,3E3))})(a)}},m=function(b){var a=d(15,45),e=d(5,10),c=d(5,
15);b.css({left:a,bottom:e,width:c,height:c});b.css({background:"#ffe4e1","border-radius":Math.round(c/2),opacity:"0.8"});b.css({background:"-webkit-gradient(radial, 20% 20%, 1, center center, "+Math.round(c/2)+", from(rgba(255,255,255,0.9)), color-stop(70%, rgba(255,255,255,0)), color-stop(99%, rgba(255,255,255,0.8)), to(rgba(255,255,255,0)))"});b.css({background:"-moz-radial-gradient(top left, rgba(255,255,255,0.8), rgba(255,255,255,0))"});b.animate({left:d(15,45),bottom:$("#tube1 .tube-liquid").height()},
{duration:9E3+d(500,5E3),specialEasing:{left:Math.random()>0.5?"easeInBounce":"easeOutBounce"},complete:function(){setTimeout(function(){m(b)},d(300,2E3))}})},q=function(){$("#testtubes").find("div.tube").each(function(){for(var b=0;b<9;b++){var a=b%2===0?16:6,c=b%2===0?"<span>"+(b+1-b/2)+"</span>":"",d="",f="";$(this).attr("id")==="tube2"&&(d="id='vol"+(b+1)*10+"' ",f="cursor:pointer;");$(this).append("<div "+d+"class='grad' style='bottom:"+(b*25+30)+"px;left:13px;width:"+a+"px;"+f+"'>"+c+"</div>")}});
o(g[0]=$.Deferred());n(g[1]=$.Deferred());$("#tube2").find(".grad").click(function(){var b=parseInt(this.id.substr(3));c.setVolume(b);var a="liquid-vol1";b===80?a="liquid-vol2":b===90&&(a="liquid-vol3");$("#tube2").find(".tube-liquid").removeClass("liquid-vol1 liquid-vol2 liquid-vol3").addClass(a).animate({height:parseInt($(this).css("bottom"))})});$("#tube-plug").click(function(){var b=$(this);if(!b.is(":animated")){var a=b.position().top===-100;a?c.pause():c.resume();b.animate({top:a?-20:-100})}});
$.when.apply(null,g).done(function(){$("#loading").remove();$("#periodictable").fadeIn();var b=[],a=0,d;for(d in f)(function(a,b){$("#thetable").queue(function(){var c=$("<div class='tile' id='a"+a.elem.an+"' style='left:"+a.elem.x*42+"px;top:0px;background:"+a.elem.backcol+";'>"+a.elem.an+"<p>"+a.elem.sym+"</p>"+a.elem.name+"</div>");$("#thetable").append(c);c.animate({top:a.elem.y*42},150,"linear",function(){$("#thetable").dequeue();b.resolve()})})})(f[d],b[a]=$.Deferred()),a++;$.when.apply(null,
b).done(function(){$("#thetable").append("<div class='tile no-hover' style='left:84px;top:210px;background:transparent;text-align:center;font-size:16px;line-height:40px;'>*</div>");$("#thetable").append("<div class='tile no-hover' style='left:84px;top:252px;background:transparent;text-align:center;font-size:16px;line-height:40px;'>**</div>");$("#thetable").append("<div class='tile no-hover' style='left:46px;top:336px;background:transparent;text-align:center;font-size:16px;line-height:40px;'>*</div>");
